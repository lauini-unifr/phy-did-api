...
spielen Klimamodelle eine wichtige Rolle.\index{Klimamodelle|(} 
Es sind auch gerade die Aussagen solcher Klimamodelle,
...
Die Solarkonstante\index{Solarkonstante} 
ist definiert als das langj\"ahrige Mittel der Intensit\"at der 
...
den 11-j\"ahrigen Aktivit\"atszyklen der Sonne.\index{Sonnenzyklus} 
Diese wirken sich aber im sichtbaren Bereich
...
Einen wesentlich gr\"o\ss eren Einfluss auf das Klima hat die Albedo\index{Albedo}
...
Ebenfalls wichtig f\"ur Klimamodelle ist der Aufbau der unteren Atmosph\"are.\index{Atmosph\"are} 
Bis zu einer
H\"ohe von rund 12--13\,km (in Poln\"ahe und im Winter ist diese Schicht etwas tiefer, in den
Tropen kann sie bis zu 18--20\,km betragen) reicht die Troposph\"are.\index{Troposph\"are} 
In dieser Schicht spielt
...
Oberhalb der Troposph\"are liegt die Stratosph\"are,\index{Stratosph\"are} 
die bis in eine H\"ohe von rund 50\,km
...
Die Luft der Atmosph\"are\index{Atmosph\"are!Zusammensetzung} 
besteht im Wesentlichen aus Stickstoff (${\rm N}_2$, rund 78\%) und
...
n\"aherungsweise in den angef\"uhrten Modellen beschrieben wird.\index{Strahlungsbilanz}

\begin{SCfigure}[30][htb]
\includegraphics[width = 0.6\textwidth]{./Bilder/Bilanz.jpg}
...
Im Folgenden verwenden wir auch das\index{Kirchhoff'sches Strahlungsgesetz}\index{Strahlungsgesetz!Kirchhoff} 
Kirchhoff'sche Strahlungsgesetz, wonach der
...
Hier wird das Stefan-Boltzmann-Gesetz\index{Strahlungsgesetz!Stefan-Boltzmann}\index{Stefan-Boltzmann-Gesetz} 
\begin{equation}
                L=\sigma T^4
\end{equation}                 
...
emittierte Intensit\"at\index{Emissionsfaktor}
\begin{equation}
...
\begin{SCfigure}[30][htb]
\includegraphics[width = 0.5\textwidth]{./Bilder/Petty.png}
...
Die Atmosph\"are\index{Atmosph\"are!Venus}\index{Venus!Atmosph\"are}\index{Klimamodell!Venus} 
der Venus enth\"alt rund 96\% Kohlendioxid. Der Abstand Venus-Sonne
...
Die Stratosph\"are\index{Klimamodell!Stratosph\"are}\index{Stratosph\"are!Klimamodell}
...
F\"ur $\beta=0$ nimmt die Stratosph\"arentemperatur mit wachsendem $\epsilon_{\rm str}$ zu.\index{Klimamodelle|)} 
