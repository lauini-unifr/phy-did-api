%\documentclass[german,10pt]{book}      \input{../preambel}         \begin{document}  \setcounter{chapter}{7}
...
Teil der Ekliptik.\index{Schlangentr\"ager (Sternbild)}\index{Ophiuchus} 
...
Sternbild Widder, weshalb man ihn auch heute noch manchmal als\index{Widderpunkt} 
...
hier sind das Fr\"uhlingsdreieck,\index{Fruehlingsdreieck@Fr\"uhlingsdreieck} 
