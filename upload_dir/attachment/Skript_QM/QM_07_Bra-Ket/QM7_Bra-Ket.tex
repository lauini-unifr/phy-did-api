...
Die Bra-Ket-Notation von Dirac \cite{Dirac} hat sich mittlerweile in der Quantentheorie
...
Der zugeh\"orige Bra-Vektor $\langle \psi |$ ist ein Element des Dualraums, das
...
Zur Notation: Wenn man von einem \glqq Zustand\grqq\ spricht, ist oftmals nicht klar, was
...
\hyperref[chap_Axiom]{Axiomatischer Zugang zur Physik}). Da im Folgenden viel von Wahrscheinlichkeiten
...
\"Ahnliches gilt f\"ur den Begriff der Observablen. Hier unterscheide ich zwischen der physikalischen
...
Ein physikalisches System wird in dem Zustand $\psi$ pr\"apariert und befindet sich nun in
diesem Zustand. Der Ket-Vektor $|\psi\rangle$ repr\"asentiert somit die Pr\"aparation eines Systems in einem
...
Projektionsoperatoren sind lineare Abbildungen -- in endlich dimensionalen Vektorr\"aumen
...
Filter. Ein (idealer) Filter hat die Eigenschaft, physikalischen Systeme in bestimmten Zust\"anden ungehindert 
...
Das Doppelspaltexperiment l\"asst sich mit den bisher beschriebenen Mitteln schon recht gut
...
damit das System in den Zustand $|\lambda_i\rangle$ zu versetzen, gleich 1 ist. 
...
der Zustand $|\psi\rangle$ erzeugt bzw.\ pr\"apariert. 
...
Ein Strahlteiler teilt einen Lichtstrahl in zwei gleiche Anteile auf. Es handelt sich dabei oft
...
behandeln. Es besteht aus zwei Strahlteilern: Der erste teilt einen Lichtstrahl in zwei Anteile,
...
F\"ur das \glqq Knallerexperiment\grqq\ m\"ussen wir den Operator $\big(|1\rangle \langle 1| + 0\cdot |2\rangle \langle 2| \big)$
...
die Vorhersage f\"ur das Eintreffen bestimmter Ereignisse. In der Quantentheorie besteht
...
$|\lambda_n\rangle$ pr\"apariert wurde, unmittelbar nach dieserr Pr\"aparation mit Sicherheit 
...
Der Ausdruck $\langle \psi |A| \psi \rangle$ ist Erwartungswert von ${\cal A}$, d.h., wenn die Observable
