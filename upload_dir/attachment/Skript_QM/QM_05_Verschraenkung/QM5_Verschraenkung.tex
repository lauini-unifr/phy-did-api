...
\info{Thomas Filk}{01.04.2024}%; BP 3.6.6 (8) \& (9)}%
M\"ochte man in der Quantentheorie Systeme beschreiben, die aus\index{Verschr\"ankung|(}
...
Wahrscheinlichkeiten\index{Konditionierte Wahrscheinlichkeit}\index{Wahrscheinlichkeit!konditionierte} 
...
Tensorprodukt von zwei Vektorr\"aumen und dem kartesischen\index{kartesisches Produkt}\index{Vektorraum!Tensorprodukt}
Produkt der Vektorr\"aume (das man auch als direkte Summe\index{Vektorraum!kartesisches Produkt}
${\cal H}_1 \oplus{\cal H}_2$ schreibt). Das kartesische Produkt\index{direkte Summe von Vektorr\"aumen}
...
Lineare Abbildungen von einem Vektorraum\index{Bra-Ket-Notation}
...
Eine besondere Form der Verschr\"ankung,\index{Messprozess} 
...
\end{eqnarray}
Man erkennt, dass in beiden F\"allen auch antikorrelierte Ergebnisse m\"oglich sind.\index{Verschr\"ankung|)}
