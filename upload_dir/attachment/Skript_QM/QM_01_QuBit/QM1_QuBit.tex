...
als ein quantenmechanisches Zwei-Zustandssystem,\index{Zwei-Zustandssystem} 
...
Eine Observable ist etwas, das man an einem System messen kann.\index{Observable} 
...
Daher bezeichnet man einen Zustand auch als ein Erwartungswertfunktional.\index{Erwartungswertfunktional} 
...
In der klassischen Mechanik beschreiben wir einen (reinen)\index{Zustand!klassische Mechanik} 
...
In der Quantenmechanik\index{Zustand!Quantenmechanik} 
...
Der Begriff der Messung ist in der Quantentheorie sehr umstritten und nicht wenige\index{Messung}
...
Messung beschrieben wird.\index{Kollapspostulat}\index{Neumann-L\"uders-Projektionspostulat} 
...
didaktischen Bereich hat sich daher der Begriff des\index{Quantenobjekt} 
...
Zwei-Zustandssysteme\index{Zwei-Zustandssystem} 
durch die Strahlen in einem
zweidimensionalen komplexen Vektorraum mit Skalarprodukt beschrieben. 
Ein Strahl ist dabei ein komplex eindimensionaler\index{Strahl}
...
Trifft ein Lichtstrahl auf eine Grenzfl\"ache wie Luft-Wasser oder Luft-Glas,\index{Polarisation}
...
In der Abbildung wurde der Polarisationsw\"urfel\index{Polarisationsw\"urfel}\index{Strahlteiler!polarisierender} 
...
F\"ur Einzelphotonen gelten im Wesentlichen dieselben Regeln,\index{Einzelphotonen} 
...
von Malus,\index{Malus, Gesetz von} 
...
$+$ und $-$ aus. In der obigen Basis gilt f\"ur die Vektoren zu dieser Polarisation:\index{Polarisation!lineare}
\begin{equation}
...
elliptischen Polarisationen):\index{Polarisation!zirkulare}
\begin{equation}
...
der hermiteschen Matrizen in dem zweidimensionalen\index{Observable!Zwei-Zustandssysteme}
komplexen Vektorraum, die wir mit der Menge der Observablen identifizieren werden. Als Basis f\"ur die hermiteschen
Matrizen bieten sich die drei Pauli-Matrizen sowie die Einheitsmatrix an:\index{Pauli-Matrizen}
\begin{equation}
...
Die Bloch-Kugel\index{Bloch-Kugel} 
...
also hermitesche Matrizen mit der Eigenschaft $P^2=P$.\index{Projektionsmatrizen} 
...
F\"ur den Fall $|\pmb{n}|<1$ erh\"alt man sogenannte Dichtematrizen.\index{Dichtematrix} 
...
vierdimensionalen komplexen Vektorraum.\index{Tensorprodukt} 
...
Vektoren, wobei folgendes\index{Summe, von Vektorr\"aumen} 
...
Diese Zust\"ande bezeichnet man als Bell-Zust\"ande:\index{Bell-Zustand}
\begin{eqnarray}
